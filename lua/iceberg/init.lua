...
local function set_hl_groups()
    ...
    hl(0, "Pmenu", { fg = "#c7c9d1", bg = "#242633" })
    hl(0, "PmenuSbar", { fg = "NONE", bg = "#242633" })
    hl(0, "PmenuSel", { fg = "#e0e2eb", bg = "#33374d" })
    ...
    hl(0, "DiagnosticFloatingHint", { fg = "#c7c9d1", bg = "#242633" })
    hl(0, "NormalFloat", { fg = "#c7c9d1", bg = "#242633" })
    hl(0, "FloatBorder", { fg = "#6c7189", bg = "#242633" })
